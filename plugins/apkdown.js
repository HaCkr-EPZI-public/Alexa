          ...
          message: {
            ...
            interactiveMessage: proto.Message.InteractiveMessage.create({
              ...
              footer: proto.Message.InteractiveMessage.Footer.create({
                text: "© 𝐂ʀᴇᴀᴛᴇᴅ 𝐁ʏ Asᴍᴏᴅᴇᴜs Eᴘᴢɪ"
              }),
              header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image: { url: `https://i.ibb.co/tZzBS47/image.jpg` } }, { upload: Matrix.waUploadToServer })),
                title: ``,
                gifPlayback: true,
                subtitle: "",
